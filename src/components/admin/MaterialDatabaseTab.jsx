    ...
    return (
      <tr className="bg-blue-50">
        <td className="px-6 py-4">
          <span className="text-sm text-gray-900">{template.material_name}</span>
        </td>
        <td className="px-6 py-4">
          <span className="text-sm text-gray-900">{template.system_type}</span>
        </td>
        <td className="px-6 py-4">
          <input
            type="text"
        ...
        <td className="px-6 py-4">
          <span className="text-sm text-gray-900">{template.unit}</span>
        </td>
        <td className="px-6 py-4">
          <input
            type="number"
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <button
              ...
              className="mb-4 px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 disabled:bg-primary-400 transition-colors font-medium"
            >
              Add Template
            </button>
            ...
            <div className="space-y-4">
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center bg-gray-50 hover:bg-gray-100 transition-colors">
                ...
                <label className="inline-block">
                  <span className="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors cursor-pointer font-medium">
                    Browse Files
                  </span>
                  <input
                    type="file"
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 disabled:bg-primary-400 transition-colors font-medium"
                >
...
export default MaterialDatabaseTab
